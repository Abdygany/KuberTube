...
export default async function AppLayout({ children }: { children: ReactNode }) {
  ...
  try {
    ...
    me = bootstrap.me;
    settings = {
      defaultLevel: bootstrap.settings.defaultLevel,
      defaultDuration: bootstrap.settings.defaultDuration,
      defaultBalance: bootstrap.settings.defaultBalance,
      defaultFreshness: bootstrap.settings.defaultFreshness,
      uiTheme: bootstrap.settings.uiTheme,
      uiLanguage: bootstrap.settings.uiLanguage,
  ...
  return (
    <UserProvider value={{ me, settings }}>
